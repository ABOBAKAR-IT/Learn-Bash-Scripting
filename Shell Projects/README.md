# 1 Create Shell Script for deploy first time Node App on Linux VPS
...
```
# 2 Create Shell Script for configure Nginx for Node App

```
sshpass -p 'Linuxjawad786' ssh jawad@20.68.108.64 'bash -s' -p4466 ';
